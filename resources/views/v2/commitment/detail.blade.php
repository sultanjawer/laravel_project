                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="justify-content-center">
                                        ...
                                        <a class="text-primary mr-1" href="/v2/pks/saprodi" role="button" data-toggle="tooltip" data-original-title="Bantuan Saprodi" data-offset="0,10"><i class="fal fa-hands-helping"></i></a>
                ...
                <div class="panel-content justify-content-center text-center">
                    <div class="row d-flex">
                        <div class="col-md-4 my-1">
                            <a href="/v2/commitment/show" class="btn btn-sm btn-primary btn-block" data-toggle="tooltip" data-offset="0,10" data-original-title="Ubah data Komitmen"><i class="fas fa-edit"></i> Ubah data Komitmen</a>
                        </div>
                        <div class="col-md-4 my-1">

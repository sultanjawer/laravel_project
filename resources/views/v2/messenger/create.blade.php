...
<div class="row">
    <div class="col-md-8">
        <input type="text" class="form-control mb-3" aria-label="Mail Subject" id="tgl_mulai" placeholder="Subject">
                ...
                <div class="panel-content">
                    <div class="form-group">
                        ...
                        <select class="select2-placeholder-multiple form-control form-control-sm" multiple="multiple" id="multiple-placeholder">
                            <optgroup label="Eksekutif">
                                <option>Direktur Jenderal</option>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="tags">Tag Pesan</label>
                    ...
                    <div class="frame-wrap">
                        ...
                        <a href="/v2/messenger/read" class="btn btn-xs btn-default" data-toggle="tooltip" title data-original-title="Lihat tampilan">Preview</a>
                    </div>
                </div>
                <div class="panel-content py-2 rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted d-flex">
                    <span class="">
                        <button class="btn btn-xs btn-danger fw-400" data-toggle="tooltip" title data-original-title="Lihat Hapus feed ini.">Drop</button>
                        <button class="btn btn-xs btn-warning fw-400" data-toggle="tooltip" title data-original-title="Drop/deaktivasi feed ini sehingga tidak tampil di seluruh dashboard pengguna">Discard</button>
                    </span>
                    <span class="ml-auto">
                        <a href="/v2/messenger/outbox" class="btn btn-xs btn-primary fw-500" data-toggle="tooltip" title data-original-title="Publikasikan feed ini ke dashboard pengguna lain.">Send</a>
                    </span>
                </div>
    ...
    $(document).ready(function() {
        $(function() {
            ...
            $(".select2-placeholder").select2({
                placeholder: "- select receipent(s)",
                allowClear: true
            });

    ...
    <div class="col-12">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 order-md-2 mb-4">
                <p class="lead fs-md">Mohon Maaf! Pengajuan Verifikasi untuk Data RIPH #: 0155/PP.240/D/03/2022 Gagal Dilakukan.</p>
                Hal ini dapat disebankan oleh:
                <ul>
                    <li>Masih terdapat syarat-syarat yang belum Anda penuhi untuk mengajukan Verifikasi (periksa teks berwarna merah pada halaman pemeriksaan sementara).</li>
                ...
                <p class="lead fs-md"><a href="/v2/pengajuan/vcheck" class="btn btn-sm btn-primary">Kembali ke halaman pemeriksaan</a></p>
            </div>
        </div>
    </div>
</div>

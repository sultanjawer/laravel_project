...
<div class="row">
    <div class="col-md-8">
        <input type="text" class="form-control mb-3" aria-label="Tanggal mulai pelaksanaan pemeriksaan" id="tgl_mulai" placeholder="Feed title here" value="LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT">
        <div class="js-summernote" value="">
            <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Phasellus quis sem diam. Sed commodo metus in ultrices consequat. Vestibulum eu orci ante. Mauris vel tincidunt mauris. Cras finibus, purus eu pharetra molestie, orci felis lacinia orci, ac congue quam turpis a nibh.</p>

            <p>Nam viverra diam magna, eget lobortis orci tincidunt sed. Donec et lobortis est. Morbi eget massa est. In iaculis odio lectus, sed efficitur nunc viverra non. Nullam molestie eros magna, eu posuere mauris posuere sit amet. Pellentesque hendrerit condimentum ipsum, euismod ornare lectus pharetra eget. Praesent semper est erat, commodo mollis arcu efficitur vitae. Maecenas gravida sit amet nisi vel interdum.</p>

            <p>Vestibulum molestie, ipsum vitae feugiat lacinia, nisi magna accumsan velit, ac semper nisi felis vitae augue. Vivamus mattis quis erat eu gravida. Integer venenatis risus vitae ullamcorper cursus. Proin sodales odio sed aliquet pulvinar. Duis ipsum erat, ultricies a dolor non, tempor dictum ante. Morbi vel metus lectus</p>
        </div>
    </div>
    <div class="col-md-4">
                ...
                <div class="panel-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm input-group-multi-transition">
                            <input type="text" class="form-control form-control-sm" aria-label="" id="tags" placeholder="tambahkan tag.." value="#skl, lunas">

    ...
    <div class="col-lg-12">
        <div class="mb-2">
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#verified"><i class="fas fa-check mr-1"></i>SKl Issued</a></li>
                <li class="nav-item"><a class="btn-sm nav-link" data-toggle="pill" href="#backdate"><i class="fas fa-check mr-1"></i>SKl Issued (backdate)</a></li>
            </ul>
        </div>

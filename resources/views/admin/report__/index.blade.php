                        ...
                        <table id="dt_tblList" class="table table-sm table-hover table-bordered w-100 dataTable text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>function</td>
                                    <td class="col">
                                        <a href="/report/commitment/detail" class="btn btn-xs btn-outline-primary">Data RIPH</a>
                                        <a href="/report/commitment/realisasi" class="btn btn-xs btn-outline-info">Ringkasan Realisasi</a>
                                        <a href="/report/commitment/map" class="btn btn-xs btn-outline-success">Pemetaan</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>

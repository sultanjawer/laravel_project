<footer class="page-footer shadow-lg" role="contentinfo">
	<div class="d-flex align-items-center flex-1 text-muted">
		<span class="hidden-md-down fw-700">YEAR © Transniaga Sukses Makmur<a href='https://rebrandz.xyz' class='text-primary fw-500' title='rebrandz.xyz' target='_blank'> rebrandz.xyz</a></span>
	</div>
	<div>
